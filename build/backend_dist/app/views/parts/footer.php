	...
	<div class="footer__wrapper">
		<div class="footer__row">
			<div class="footer__column footer__column_left">
				<a href="/works" class="footer__link preload-link">Мои работы</a>
				<a href="/about" class="footer__link preload-link">Обо мне</a>
				<a href="/blog" class="footer__link preload-link">Блог</a>
				<a href="/" class="footer__link preload-link">Авторизация</a>
			</div>
			<div class="footer__column footer__column_right">
				<ul class="social-links">
					<li class="social-links__item social-links__item_svg"><a href="https://ru.linkedin.com/in/homafromptz" target="_blank" class="social-links__svg-link">
					...
					<li class="social-links__item social-links__item_svg"><a href="https://vk.com/homafromptz" target="_blank" class="social-links__svg-link">
					...
					<li class="social-links__item social-links__item_svg"><a href="https://github.com/HomAfromPTZ" target="_blank" class="social-links__svg-link">
		...
		<div class="footer__row">
			<div class="footer__column footer__column_left"><span class="footer__quote"><i>“It is so shocking to find out how many people do not believe that they can learn, and how many more believe learning to be difficult.”</i> ― Frank Herbert, Dune</span></div>
			<div class="footer__column footer__column_right"><span class="copyright">&copy; Лембинен Николай</span><span class="copyright copyright_slogan">To boldly go where no man has gone before</span><span class="copyright">2016</span></div>
		</div>
	</div>
</footer>